...
val kSetting: String = "com.vc137.boids.simulation.K_NEAREST_NEIGHBORS_SETTING"
...
val maxAccelerationSetting = "com.vc137.boids.simulation.MAX_ACCELERATION_SETTING"

fun Map<String, Any>.getMaxAcceleration(): Double {
    return max(get(maxAccelerationSetting) as? Double ?: 0.0, 0.0)
}

val maxVelocitySetting = "com.vc137.boids.simulation.MAX_VELOCITY_SETTING"
...
val cohesionSetting = "com.vc137.boids.simulation.COHESION_SETTING"

fun Map<String, Any>.getCohesion(): Double {
    return max(get(cohesionSetting) as? Double ?: 0.0, 0.0)
}

val separationSetting = "com.vc137.boids.simulation.SEPARATION_SETTING"

fun Map<String, Any>.getSeparation(): Double {
    return max(get(separationSetting) as? Double ?: 0.0, 0.0)
}

val separationCutoffSetting = "com.vc137.boids.simulation.SEPARATION_CUTOFF_SETTING"
